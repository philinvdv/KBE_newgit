...
# Select the nodes at the root and create a node set
# leaf = dgo.LeafFromNodeSets(nodeSets=("SET", "SET-1", "SET-2", "SET-3", ))
# dg = session.DisplayGroup(leaf=leaf, name='BC_nodes')
